...
OUTPUT_FILE   = "results/few_shot_llama_predictions.csv"
...
# ── System prompt (same decision framework as few_shot_gpt4.py) ───────────────
...
print(f"Using model: {MODEL_ID} (local) with {len(few_shot_df)} few-shot examples\n")
